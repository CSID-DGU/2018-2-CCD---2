package git.comcsid_dgu2018_2_ccd_dgdg_2.github.dgdg;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dongguk = new LatLng(37.5574771, 127.0020518);
        mMap.addMarker(new MarkerOptions().position(dongguk).title("동국대학교"));
